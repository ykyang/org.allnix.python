...
#
# Created: Sun Sep 16 16:14:57 2018
...
class Ui_ThemeWidgetForm(object):
    def setupUi(self, ThemeWidgetForm):
        ...
        QtCore.QObject.connect(self.themeComboBox, QtCore.SIGNAL("currentIndexChanged(int)"), ThemeWidgetForm.updateUI)
        QtCore.QObject.connect(self.antialiasCheckBox, QtCore.SIGNAL("toggled(bool)"), ThemeWidgetForm.updateUI)
        QtCore.QObject.connect(self.legendComboBox, QtCore.SIGNAL("currentIndexChanged(int)"), ThemeWidgetForm.updateUI)
        QtCore.QObject.connect(self.animatedComboBox, QtCore.SIGNAL("currentIndexChanged(int)"), ThemeWidgetForm.updateUI)
        QtCore.QMetaObject.connectSlotsByName(ThemeWidgetForm)

    def retranslateUi(self, ThemeWidgetForm):
        self.themeLabel.setText(QtWidgets.QApplication.translate("ThemeWidgetForm", "Theme:", None, -1))
        self.animatedLabel.setText(QtWidgets.QApplication.translate("ThemeWidgetForm", "Animation:", None, -1))
        self.legendLabel.setText(QtWidgets.QApplication.translate("ThemeWidgetForm", "Legend:", None, -1))
        self.antialiasCheckBox.setText(QtWidgets.QApplication.translate("ThemeWidgetForm", "Anti-aliasing", None, -1))
